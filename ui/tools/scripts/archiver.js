...
const buildPath = path.resolve(
  resolveTargetPath(project.data?.targets?.build?.options?.outputPath)
);

const outputPath = path.resolve(
  resolveTargetPath(project.data?.targets?.zip?.options?.outputPath)
);
const fileName = project.data?.targets?.zip?.options?.zipName;
const ZIP = path.resolve(outputPath, fileName);
