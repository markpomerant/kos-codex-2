...
/**
 * Type aliases for connections API
 */
...
/**
 * Get client response type for connections API
 */
...
/**
 * Get execution context type for connections API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with connections API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the connections OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/connections/v1/service';
 ...
 *   // Fully typed based on connections API
 * }
 * ```
 */
...
/**
 * One endpoint of the connections API: a path and the method it is called with.
 */
...
/**
 * Create an API client for connections
 */
