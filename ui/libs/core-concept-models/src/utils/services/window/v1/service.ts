...
/**
 * Get client response type for window API
 */
...
/**
 * Get execution context type for window API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with window API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the window OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/window/v1/service';
 ...
 *   // Fully typed based on window API
 * }
 * ```
 */
...
/**
 * One endpoint of the window API: a path and the method it is called with.
 */
...
/**
 * Create an API client for window
 */
