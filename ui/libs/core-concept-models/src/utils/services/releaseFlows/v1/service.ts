...
/**
 * Type aliases for releaseFlows API
 */
...
/**
 * Get client response type for releaseFlows API
 */
...
/**
 * Get execution context type for releaseFlows API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with releaseFlows API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the releaseFlows OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/releaseFlows/v1/service';
 ...
 *   // Fully typed based on releaseFlows API
 * }
 * ```
 */
...
/**
 * One endpoint of the releaseFlows API: a path and the method it is called with.
 */
...
/**
 * Create an API client for releaseFlows
 */
