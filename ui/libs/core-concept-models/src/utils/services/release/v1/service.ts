...
/**
 * Get client response type for release API
 */
...
/**
 * Get execution context type for release API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with release API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the release OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/release/v1/service';
 ...
 *   // Fully typed based on release API
 * }
 * ```
 */
...
/**
 * One endpoint of the release API: a path and the method it is called with.
 */
...
/**
 * Create an API client for release
 */
