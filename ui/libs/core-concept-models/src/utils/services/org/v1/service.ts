...
/**
 * Get client response type for org API
 */
...
/**
 * Get execution context type for org API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with org API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the org OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/org/v1/service';
...
/**
 * One endpoint of the org API: a path and the method it is called with.
 */
