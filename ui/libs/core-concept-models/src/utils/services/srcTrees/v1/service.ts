...
/**
 * Get client response type for srcTrees API
 */
...
/**
 * Get execution context type for srcTrees API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with srcTrees API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the srcTrees OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/srcTrees/v1/service';
 ...
 *   // Fully typed based on srcTrees API
 * }
 * ```
 */
...
/**
 * One endpoint of the srcTrees API: a path and the method it is called with.
 */
...
/**
 * Create an API client for srcTrees
 */
