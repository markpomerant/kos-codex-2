export interface paths {
    "/api/instanceCache/artifactInstance/{instanceId}/{market}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Download the instance and return the file path (v1.0) */
        get: {
            parameters: {
                query?: never;
                header?: never;
        ...
        put?: never;
        /** Download the instance and copy the file to location specified in the body request. (v1.0) */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["cc875fa7-bfb7-4037-9080-f75452fb8db1"];
                };
            };
            responses: {
                /** @description OK */
...
export interface components {
    schemas: {
        ...
        "cc875fa7-bfb7-4037-9080-f75452fb8db1": {
            dir?: string;
        };
    };
    responses: never;
