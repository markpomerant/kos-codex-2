...
/**
 * Type aliases for instanceCache API
 */
...
/**
 * Get client response type for instanceCache API
 */
...
/**
 * Get execution context type for instanceCache API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with instanceCache API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the instanceCache OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/instanceCache/v1/service';
 ...
 *   // Fully typed based on instanceCache API
 * }
 * ```
 */
...
/**
 * One endpoint of the instanceCache API: a path and the method it is called with.
 */
...
/**
 * Create an API client for instanceCache
 */
