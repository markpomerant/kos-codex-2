...
/**
 * Get client response type for updater API
 */
...
/**
 * Get execution context type for updater API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with updater API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the updater OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/updater/v1/service';
 ...
 *   // Fully typed based on updater API
 * }
 * ```
 */
...
/**
 * One endpoint of the updater API: a path and the method it is called with.
 */
...
/**
 * Create an API client for updater
 */
