...
/**
 * Get client response type for keys API
 */
...
/**
 * Get execution context type for keys API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with keys API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the keys OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/keys/v1/service';
...
/**
 * One endpoint of the keys API: a path and the method it is called with.
 */
