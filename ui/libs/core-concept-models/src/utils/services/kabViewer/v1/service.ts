...
/**
 * Type aliases for kabViewer API
 */
...
/**
 * Get client response type for kabViewer API
 */
...
/**
 * Get execution context type for kabViewer API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with kabViewer API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the kabViewer OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/kabViewer/v1/service';
 ...
 *   // Fully typed based on kabViewer API
 * }
 * ```
 */
...
/**
 * One endpoint of the kabViewer API: a path and the method it is called with.
 */
...
/**
 * Create an API client for kabViewer
 */
