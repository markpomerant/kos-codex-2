...
/**
 * Get client response type for devices API
 */
...
/**
 * Get execution context type for devices API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with devices API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the devices OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/devices/v1/service';
 ...
 *   // Fully typed based on devices API
 * }
 * ```
 */
...
/**
 * One endpoint of the devices API: a path and the method it is called with.
 */
...
/**
 * Create an API client for devices
 */
