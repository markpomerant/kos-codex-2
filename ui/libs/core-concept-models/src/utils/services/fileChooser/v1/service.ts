...
/**
 * Type aliases for fileChooser API
 */
...
/**
 * Get client response type for fileChooser API
 */
...
/**
 * Get execution context type for fileChooser API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with fileChooser API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the fileChooser OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/fileChooser/v1/service';
 ...
 *   // Fully typed based on fileChooser API
 * }
 * ```
 */
...
/**
 * One endpoint of the fileChooser API: a path and the method it is called with.
 */
...
/**
 * Create an API client for fileChooser
 */
