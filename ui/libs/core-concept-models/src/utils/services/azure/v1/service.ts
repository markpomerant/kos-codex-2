...
/**
 * Get client response type for azure API
 */
...
/**
 * Get execution context type for azure API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with azure API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the azure OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/azure/v1/service';
 ...
 *   // Fully typed based on azure API
 * }
 * ```
 */
...
/**
 * One endpoint of the azure API: a path and the method it is called with.
 */
...
/**
 * Create an API client for azure
 */
