...
/**
 * Get client response type for handles API
 */
...
/**
 * Get execution context type for handles API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with handles API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the handles OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/handles/v1/service';
 ...
 *   // Fully typed based on handles API
 * }
 * ```
 */
...
/**
 * One endpoint of the handles API: a path and the method it is called with.
 */
...
/**
 * Create an API client for handles
 */
