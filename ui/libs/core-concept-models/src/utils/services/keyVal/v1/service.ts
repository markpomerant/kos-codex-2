...
/**
 * Get client response type for keyVal API
 */
...
/**
 * Get execution context type for keyVal API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with keyVal API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the keyVal OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/keyVal/v1/service';
 ...
 *   // Fully typed based on keyVal API
 * }
 * ```
 */
...
/**
 * One endpoint of the keyVal API: a path and the method it is called with.
 */
...
/**
 * Create an API client for keyVal
 */
