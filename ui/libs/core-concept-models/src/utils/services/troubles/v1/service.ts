...
/**
 * Get client response type for troubles API
 */
...
/**
 * Get execution context type for troubles API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with troubles API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the troubles OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/troubles/v1/service';
 ...
 *   // Fully typed based on troubles API
 * }
 * ```
 */
...
/**
 * One endpoint of the troubles API: a path and the method it is called with.
 */
...
/**
 * Create an API client for troubles
 */
