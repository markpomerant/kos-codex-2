...
/**
 * Type aliases for buildAutomation API
 */
...
/**
 * Get client response type for buildAutomation API
 */
...
/**
 * Get execution context type for buildAutomation API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with buildAutomation API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the buildAutomation OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/buildAutomation/v1/service';
 ...
 *   // Fully typed based on buildAutomation API
 * }
 * ```
 */
...
/**
 * One endpoint of the buildAutomation API: a path and the method it is called with.
 */
...
/**
 * Create an API client for buildAutomation
 */
