...
/**
 * Get client response type for codex API
 */
...
/**
 * Get execution context type for codex API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with codex API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the codex OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/codex/v1/service';
 ...
 *   // Fully typed based on codex API
 * }
 * ```
 */
...
/**
 * One endpoint of the codex API: a path and the method it is called with.
 */
...
/**
 * Create an API client for codex
 */
