...
/**
 * Type aliases for internalRepos API
 */
...
/**
 * Get client response type for internalRepos API
 */
...
/**
 * Get execution context type for internalRepos API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with internalRepos API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the internalRepos OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/internalRepos/v1/service';
 ...
 *   // Fully typed based on internalRepos API
 * }
 * ```
 */
...
/**
 * One endpoint of the internalRepos API: a path and the method it is called with.
 */
...
/**
 * Create an API client for internalRepos
 */
