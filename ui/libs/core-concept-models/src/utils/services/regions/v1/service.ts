...
/**
 * Get client response type for regions API
 */
...
/**
 * Get execution context type for regions API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with regions API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the regions OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/regions/v1/service';
 ...
 *   // Fully typed based on regions API
 * }
 * ```
 */
...
/**
 * One endpoint of the regions API: a path and the method it is called with.
 */
...
/**
 * Create an API client for regions
 */
