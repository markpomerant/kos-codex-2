...
/**
 * Get client response type for vms API
 */
...
/**
 * Get execution context type for vms API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with vms API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the vms OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/vms/v1/service';
...
/**
 * One endpoint of the vms API: a path and the method it is called with.
 */
