...
/**
 * Get client response type for openapi API
 */
...
/**
 * Get execution context type for openapi API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with openapi API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the openapi OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/openapi/v1/service';
 ...
 *   // Fully typed based on openapi API
 * }
 * ```
 */
...
/**
 * One endpoint of the openapi API: a path and the method it is called with.
 */
...
/**
 * Create an API client for openapi
 */
