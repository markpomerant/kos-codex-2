...
/**
 * Get client response type for keysets API
 */
...
/**
 * Get execution context type for keysets API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with keysets API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the keysets OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/keysets/v1/service';
 ...
 *   // Fully typed based on keysets API
 * }
 * ```
 */
...
/**
 * One endpoint of the keysets API: a path and the method it is called with.
 */
...
/**
 * Create an API client for keysets
 */
