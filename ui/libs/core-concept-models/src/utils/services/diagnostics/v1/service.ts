...
/**
 * Type aliases for diagnostics API
 */
...
/**
 * Get client response type for diagnostics API
 */
...
/**
 * Get execution context type for diagnostics API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with diagnostics API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the diagnostics OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/diagnostics/v1/service';
 ...
 *   // Fully typed based on diagnostics API
 * }
 * ```
 */
...
/**
 * One endpoint of the diagnostics API: a path and the method it is called with.
 */
