...
/**
 * Get client response type for studio API
 */
...
/**
 * Get execution context type for studio API
 */
...
/**
 * Typed decorator factory for @kosServiceRequest with studio API types
 *
 * Provides full IntelliSense and type safety for path, query params, and body
 * based on the studio OpenAPI schema.
 *
 * @example
 * ```typescript
 * import { kosServiceRequest } from '../../utils/services/studio/v1/service';
 ...
 *   // Fully typed based on studio API
 * }
 * ```
 */
...
/**
 * One endpoint of the studio API: a path and the method it is called with.
 */
...
/**
 * Create an API client for studio
 */
